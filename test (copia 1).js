...
//let peliculao = {...movies.title, ...test2};

//console.log(peliculao); 
let cpeliculas = movies.length;
for (i = 0 ; i < cpeliculas ; i ++) {
      
    let ingresar = movies[i];
    for(nombre in ingresar) {
        test2.push(ingresar.title);
     //   console.log(ingresar.title);
    }
